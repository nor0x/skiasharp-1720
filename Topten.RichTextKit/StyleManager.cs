    ...
    public class StyleManager
    {
        ...
        public IStyle FromStyle(IStyle value)
        {
            ...
            return Update(value.FontFamily, value.FontSize, value.FontWeight, value.FontItalic,
                            ...
                            value.LetterSpacing, value.FontVariant, value.TextDirection, value.ReplacementCharacter, value.A);
        }
        ...
        public IStyle A(string a) => Update(a: a);
            ...
            )
        {
            ...
            var rA = a ?? _currentStyle?.A;

            // Format key
            var key = $"{rFontFamily}.{rFontSize}.{rFontWeight}.{rFontItalic}.{rUnderline}.{rStrikeThrough}.{rLineHeight}.{rTextColor}.{rBackgroundColor}.{rLetterSpacing}.{rFontVariant}.{rTextDirection}.{rReplacementCharacter}.{rA}";
