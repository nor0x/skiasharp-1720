...
namespace Topten.RichTextKit
{
    ...
    internal class TextShaper : IDisposable
    {
        ...
        private void ApplyFontMetrics(ref Result r, float fontSize)
        {
            // And some other useful metrics
            r.Ascent = FontMetrics.Metrics.ContainsKey(_typeface) ?  FontMetrics.Metrics[_typeface].Ascent * fontSize : _fontMetrics.Ascent / overScale * fontSize;
            r.Leading = FontMetrics.Metrics.ContainsKey(_typeface) ? FontMetrics.Metrics[_typeface].Leading * fontSize : _fontMetrics.Leading / overScale * fontSize;
            r.Descent = FontMetrics.Metrics.ContainsKey(_typeface) ? FontMetrics.Metrics[_typeface].Descent * fontSize : _fontMetrics.Descent / overScale * fontSize;
            r.XMin = _fontMetrics.XMin * fontSize/ overScale;
        }
