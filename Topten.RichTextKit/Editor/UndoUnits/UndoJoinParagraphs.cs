...
namespace Topten.RichTextKit.Editor.UndoUnits
{
    class UndoJoinParagraphs : UndoUnit<TextDocument>
    {
        ...
        public override void Do(TextDocument context)
        {
            ...
            if (_removedParagraph.NumberedListIndex >= 0)
            {
                _numberedListIndex = _removedParagraph.NumberedListIndex;
                _removedParagraph.NumberedList.Remove(_removedParagraph);
            }
        }
        ...
        public override void Undo(TextDocument context)
        {
            ...
            _removedParagraph.NumberedList?.Insert(_numberedListIndex, _removedParagraph);
        }
