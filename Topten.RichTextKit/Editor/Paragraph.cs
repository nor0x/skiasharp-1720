...
namespace Topten.RichTextKit.Editor
{
    ...
    public abstract class Paragraph : IRun
    {
        ...
        public float ListContentXCoord { get; internal set; }

        public float ListTextOffset { get; set; } = -1;
        ...
        /// <summary>
        /// Gets list kind, by default ListKind.None which means that paragraph doesn't belong any list
        /// </summary>
        public ListKind ListKind { get; internal set; } = ListKind.None;

        public bool FirstParaInList { get; set; } = true;

        /// <summary>
        /// Gets numbering list index. If ListKind equals to NumberingList and ListIndex is not set
        /// the paragraph is supposed to belong to the same list as the paragraph above (if it has ListKind equals to NumberingList)
        /// </summary>
        public int NumberedListIndex => NumberedList?.IndexOf(this) ?? -1;

        public List<Paragraph> NumberedList { get; internal set; }
        ...
        public virtual void CopyStyleFrom(Paragraph other)
        {
            ...
            this.ListTextOffset = other.ListTextOffset;
            this.NumberedList = other.NumberedList;
            this.BulletColor = other.BulletColor;
            if (ListKind == ListKind.NumberingList)
            {
                this.NumberedList?.Insert(other.NumberedListIndex + 1, this);
            }
        }
        ...
        public float BulletCenterXCoord { get; internal set; }
        
        public float BulletCenterYCoord { get; internal set; }
        
        public float BulletRadius { get; internal set; }

        public SKColor BulletColor { get; set; } = SKColors.Black;
        
        public FontRun NumberedListRun { get; internal set; }
        
        public float NumberingListContentXCoord { get; internal set; }
